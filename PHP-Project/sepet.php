...
// Sepet işlemleri
if (isset($_GET['ekle'])) {
    $eklenecekUrunID = $_GET['ekle'];

    // Eğer ürün zaten sepette varsa, sadece miktarını artır
    $musteriID = $_SESSION['Musteri_id'];
    $checkQuery = "SELECT * FROM sepet WHERE Musteriler_id = $musteriID AND Urunler_id = $eklenecekUrunID";
    ...
    if ($checkResult->num_rows > 0) {
        ...
        $insertQuery = "INSERT INTO sepet (Musteriler_id, Urunler_id, adet) VALUES ($musteriID, $eklenecekUrunID, 1)";
