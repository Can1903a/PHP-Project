...
$signupLink = "<a class='nav-link' href='/PHP-Project/singup.php.php'>Kayıt Ol</a>";
    ...
    <div class="swiper-wrapper">
        ...
        while ($randomProduct = $randomProductsResult->fetch_assoc()) {
            echo '<div class="swiper-slide">';
                // Resmi BLOB olarak çekme ve base64 kodlama
                $imageData = $randomProduct['Resim_BLOB'];
                $imageSrc = 'data:image/jpeg;base64,' . base64_encode($imageData);

                echo '<img src="' . $imageSrc . '" alt="' . $randomProduct['Urunler_Adi'] . '">';
