...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        ...
        <form class="d-flex" action="/PHP-Project/search.php" method="GET">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <?php if (!empty($searchTerm)): ?>
                <h4>Arama Sonuçları: "<?php echo $searchTerm; ?>"</h4>
                <div class="row">
                    <?php
                    if ($searchResult->num_rows > 0) {
                        while ($product = $searchResult->fetch_assoc()) {
                        ...
                        echo '<p>Arama teriminize uygun ürün bulunamadı.</p>';
                    }
                    ?>
                </div>
            <?php else: ?>
